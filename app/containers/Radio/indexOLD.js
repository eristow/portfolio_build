...
const radioUrl1 = 'http://www.partyviberadio.com:8004/;listen.pls?sid=1';
...
export function Radio() {
  ...
  // const srcs = [radioUrl1, audioUrl1, audioUrl2];
  ...
  const src = radioUrl1;
  const { howl, state } = useHowl({ src, html5: true });
  ...
  return (
    <Container>
      <Play howl={howl} volume={volume} pause={play} mute={mute} />
      {state === 'loaded' ? (
        <>
          <h2>
            NOW PLAYING: Party Vibe Radio (Drum and Bass)
